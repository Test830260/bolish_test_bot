  ...
  return (
    <div style={{ background: "#08080e", minHeight: "100vh", paddingBottom: 20 }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10, padding: "0 16px" }}>
        <button
          onClick={() => game.startGame(game.level)}
          style={{ padding: 13, borderRadius: 13, border: "1px solid #28283a", background: "#181824", color: "#f1f1fa", fontSize: 13, fontWeight: 600, cursor: "pointer", fontFamily: "'Outfit',sans-serif" }}
        >
          🔄 Yangi o'yin
        </button>
        <button
      ...
      <StatsModal
        ...
        stats={{
          ...
          bestEasy: stats.bestEasy,
          bestMedium: stats.bestMedium,
          bestHard: stats.bestHard,
          rank: getRank()
        }}
      />
    </div>
